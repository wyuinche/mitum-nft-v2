...
func NewTransferNFTsItemSingleNFT(from, to base.Address, nftid nft.NFTID, cid currency.CurrencyID) TransferNFTsItemSingleNFT {
	return TransferNFTsItemSingleNFT{
		BaseTransferNFTsItem: NewBaseTransferNFTsItem(TransferNFTsItemSingleNFTHint, from, to, []nft.NFTID{nftid}, cid),
	}
}
