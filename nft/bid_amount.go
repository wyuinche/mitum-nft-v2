...
func NewBidNFTFact(token []byte, sender base.Address, broker Symbol, nft NFTID, amount currency.Amount) BidNFTFact {
	fact := BidNFTFact{
...
func (fact BidNFTFact) Broker() Symbol {
	return fact.broker
}

func (fact BidNFTFact) NFT() NFTID {
	return fact.nft
}
