...
func NewApproveNFTsFact(token []byte, sender base.Address, approved base.Address, nfts []NFTID, cid currency.CurrencyID) ApproveNFTsFact {
...
func (fact ApproveNFTsFact) NFTs() []NFTID {
	return fact.nfts
}
